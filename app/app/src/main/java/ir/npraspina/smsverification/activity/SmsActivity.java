package ir.npraspina.smsverification.activity;
...
import ir.npraspina.smsverification.R;
import ir.npraspina.smsverification.app.Config;
import ir.npraspina.smsverification.app.MyApplication;
import ir.npraspina.smsverification.helper.PrefManager;
import ir.npraspina.smsverification.service.HttpService;
    ...
    private void requestForSMS(final String name, final String email, final String mobile) {
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            public void onErrorResponse(VolleyError error) {
                Log.e(TAG, "Error3: " + error.getMessage());
                Toast.makeText(getApplicationContext(),
